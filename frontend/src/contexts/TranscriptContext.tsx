      ...
      try {
        ...
        unlistenFn = await transcriptService.onTranscriptUpdate((update) => {
          ...
          const newTranscript: Transcript = {
            ...
            speaker_id: update.speaker_id ?? undefined,
            speaker_fingerprint: update.speaker_fingerprint ?? undefined,
            source_overlap: update.source_overlap,
            sequence_id: update.sequence_id,
      ...
      if (recordingState.isRecording && transcripts.length === 0) {
        try {
          ...
          const formattedTranscripts: Transcript[] = history.map((segment: any) => ({
            ...
            speaker_fingerprint: segment.speaker_fingerprint,
            source_overlap: segment.source_overlap,
