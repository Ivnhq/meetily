...
export function TranscriptPanel({
  ...
  return (
    <div ref={transcriptContainerRef} className="w-full border-r border-gray-200 bg-white flex flex-col xl:flex-row overflow-y-auto">
      ...
      <LiveNotesPanel
        ...
        isUpdating={isUpdatingLiveNotes}
        error={liveNotesError}
        onGenerateUpdate={() => generateUpdate('manual')}
        onRecap={() => generateUpdate('recap')}
